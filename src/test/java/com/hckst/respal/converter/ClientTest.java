...
class ClientTest {
    private static final String DEV_SIGN_UP_URL = "http://localhost:3000/signup/social?uid=";
    private static final String DEV_CALL_BACK_URL = "http://localhost:3000/main";
