...
public class QOauthTmp extends EntityPathBase<OauthTmp> {
    ...
    public final com.hckst.respal.authentication.oauth.presentation.dto.response.info.QUserInfo userInfo;
    ...
    public QOauthTmp(Class<? extends OauthTmp> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userInfo = inits.isInitialized("userInfo") ? new com.hckst.respal.authentication.oauth.presentation.dto.response.info.QUserInfo(forProperty("userInfo")) : null;
    }
