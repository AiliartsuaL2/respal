...
public class QResumeDetailResponseDto extends ConstructorExpression<ResumeDetailResponseDto> {
    ...
    public QResumeDetailResponseDto(com.querydsl.core.types.Expression<Long> resumeId, com.querydsl.core.types.Expression<String> title, com.querydsl.core.types.Expression<String> content, com.querydsl.core.types.Expression<String> filePath, com.querydsl.core.types.Expression<Integer> views, com.querydsl.core.types.Expression<Long> membersId, com.querydsl.core.types.Expression<String> membersNickname, com.querydsl.core.types.Expression<String> membersPicture, com.querydsl.core.types.Expression<com.hckst.respal.converter.TFCode> mainYn, com.querydsl.core.types.Expression<com.hckst.respal.converter.TFCode> modifyYn, com.querydsl.core.types.Expression<java.time.LocalDateTime> regTime, com.querydsl.core.types.Expression<java.time.LocalDateTime> modifyTime, com.querydsl.core.types.Expression<Long> commentCount) {
        super(ResumeDetailResponseDto.class, new Class<?>[]{long.class, String.class, String.class, String.class, int.class, long.class, String.class, String.class, com.hckst.respal.converter.TFCode.class, com.hckst.respal.converter.TFCode.class, java.time.LocalDateTime.class, java.time.LocalDateTime.class, long.class}, resumeId, title, content, filePath, views, membersId, membersNickname, membersPicture, mainYn, modifyYn, regTime, modifyTime, commentCount);
    }
