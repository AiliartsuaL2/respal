...
public class CommentController {
    ...
    public void create(@RequestBody CreateCommentRequestDto createCommentRequestDto,
                                            @AuthenticationPrincipal Members members,
                                            @PathVariable Long resumeId) {
        commentService.createComment(createCommentRequestDto, members.getId(), resumeId);
    }
