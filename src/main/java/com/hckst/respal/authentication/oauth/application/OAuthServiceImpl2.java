...
public class OAuthServiceImpl2 implements OAuthService2{
    ...
    private Token checkNewUser(Provider provider, Client client, String code, String uid) {
        ...
        String oauthRedirectUri = String.join("/", OAUTH_REDIRECT_URI_PREFIX
                , "oauth"
    ...
    private OAuthToken getAccessToken(Info providerInfo, String code, String redirectUrl) {
        ...
        OAuthToken oAuthToken = gson.fromJson(json, OAuthToken.class);
        return oAuthToken;
    }
